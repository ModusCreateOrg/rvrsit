            ...
            '<div style="padding-top: 5px;">',
                ...
                '<div class="othello-scorecard-score-keeper">',
                    '<span class="othello-scorecard-score-container">',
                        '<img style="" class="othello-scorecard-player-turn" height="32px" src="node/public/impactjs/media/images/rvrs-wht.png">',
                    '</span>',
                    '<span class="othello-scorecard-score-keeper-white">0</span>',
                    '<br />',
                    '<span class="othello-scorecard-score-container">',
                        '<img class="othello-scorecard-player-turn" height="32px" src="node/public/impactjs/media/images/rvrs-blck.png">',
                    '</span>',
